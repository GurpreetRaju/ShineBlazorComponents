using ShineBlazor.Components.Demo.Data;
using System.Reflection;
using System.Text.Json;

namespace ShineBlazor.Components.Demo
{
    /// <summary>
    /// Dummy data provider.
    /// </summary>
    public class DummyDataProvider
    {
        ...
        /// Gets the fruits.
        /// </summary>
        public Task<InfiniteScrollItemsResponse<FruitData>> GetFruits(InfiniteScrollItemsRequest request)
        {
            var response = new InfiniteScrollItemsResponse<FruitData>();

            if (request != null)
            {
                response.TotalItems = DummyData.Fruits.Length;
                response.Items = DummyData.Fruits.Skip(request.SkipCount).Take(request.PageSize).ToArray() ?? [];
            }
        ...
        private void LoadDummyData()
        {
            ...
            var resourceName = "ShineBlazor.Components.Demo.Resources.fruits.json";
